...
void CFiguras::cascaron(float altura, float largo, float profundidad, GLuint text, GLuint text2, GLuint text3, GLuint text4, GLuint text5)  //Funcion creacion prisma
{
